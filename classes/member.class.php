...
class member extends myDB {
	...
	private function searchMember($sql) {
		// select SQL문 실행
	...
	public function displayMemberById($id, $title="", $html_string="") {
		// SQL문 조립
		$sql = "SELECT * FROM members WHERE id = " . $id;
		$this->searchMember($sql);
		$this->displayMember($title, $html_string);
	}
